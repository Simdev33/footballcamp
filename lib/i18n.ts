...
export const translations = {
  hu: {
    ...
    whyDifferent: {
      badge: "Ezért más",
      title: "Ezért más ez a",
      titleHighlight: "focitábor",
      items: [
        ...
        { title: "Fókuszált edzéskörnyezet", desc: "12–15 fős csoportok, ahol minden gyerek személyes figyelmet kap" },
    ...
    targetAudience: {
      ...
      text: "Ez a tábor azoknak a 7–14 éves fiúknak szól, akik nem csak focizni szeretnek, hanem fejlődni is akarnak. És azoknak a szülőknek, akik fontosnak tartják, hogy a gyermekük minőségi, szakmailag megalapozott környezetben fejlődjön.",
      items: [
  ...
  en: {
    ...
    whyDifferent: {
      ...
      items: [
        ...
        { title: "Focused training environment", desc: "Groups of 12–15, where every child receives personal attention" },
    ...
    targetAudience: {
      ...
      text: "This camp is for boys aged 7–14 who don't just want to play football, but also want to improve. And for parents who value quality, professionally grounded development for their children.",
      items: [
