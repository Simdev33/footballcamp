...
export const translations = {
  hu: {
    ...
    whySpecial: {
      ...
      bullets: [
        "Profi edzők az SL Benfica és az Atlético Madrid akadémiáiról – nem hobbi szintű oktatás, hanem nemzetközi módszertan.",
        "Napi 4 edzés angol és magyar nyelven, maximum 15 fős kiscsoportokban, ahol minden gyerek egyéni figyelmet kap.",
        "A gyerekek technikailag és emberileg is fejlődnek: csapatszellem, önbizalom, kitartás és sportszerűség.",
        "Oklevéllel, élményekkel és új barátságokkal térnek haza – nem csak egy tábor, hanem egy fordulópont.",
      ],
      statValue: "10+",
  ...
  en: {
    ...
    whySpecial: {
      ...
      bullets: [
        "Professional coaches from SL Benfica and Atlético Madrid academies – real international methodology, not hobby-level training.",
        "4 daily sessions in English and Hungarian, in groups of max 15, so every child gets individual attention.",
        "Kids grow technically and personally: teamwork, confidence, perseverance and sportsmanship.",
        "They go home with a certificate, lifelong memories and new friendships – not just a camp, but a turning point.",
      ],
      statValue: "10+",
