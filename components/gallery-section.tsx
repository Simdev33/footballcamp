...
type GalleryAlts = {
  trainingOnField: string
  kidsWithCoach: string
  teamwork: string
  kicking: string
}
...
export function GallerySection() {
  const { t } = useLanguage()
  const alts = (t as unknown as { imageAlts: GalleryAlts }).imageAlts

  const GALLERY_IMAGES = [
    { src: `${CDN}/site/edzes-kozben.jpg`, alt: alts.trainingOnField, span: "col-span-1 row-span-1" },
    { src: `${CDN}/Photos/14-Pavlidis_2.png`, alt: "Pavlidis — SL Benfica", span: "col-span-1 row-span-2" },
    { src: `${CDN}/site/gyerekek-edzovel.jpg`, alt: alts.kidsWithCoach, span: "col-span-1 row-span-1" },
    { src: `${CDN}/Photos/5-BARRENECHEA-3.png`, alt: "Barrenechea — SL Benfica", span: "col-span-1 row-span-2" },
    { src: `${CDN}/site/gyerekcsapat.jpg`, alt: alts.teamwork, span: "col-span-1 row-span-1" },
    { src: `${CDN}/Photos/84-Joao-Rego.png`, alt: "João Rego — SL Benfica", span: "col-span-1 row-span-1" },
    { src: `${CDN}/site/kickoff-labdaval.jpg`, alt: alts.kicking, span: "col-span-1 row-span-1" },
