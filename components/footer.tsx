...
import { Facebook, Instagram, Youtube, ArrowRight, Sparkles } from "lucide-react"
...
export function Footer() {
  ...
  return (
    <footer className="relative bg-[#0a1f0a] text-white border-t border-[#1a3a1a] overflow-hidden">
      <div className="relative z-10 max-w-[1800px] mx-auto px-6 md:px-12 lg:px-24 py-14 lg:py-20">
